    ...
    <div className={`overflow-hidden ${dark && 'darkBackground'}`}>
      ...
      <div className={style.wrapper}>
        ...
        <div className={style.section}>
          ...
          25. NUVA NFT is a company incorporated in England and Wales with registered number 13800011 whose registered address is 75 Whitechapel Road, London, E1 1DU and it operates the Website www.nuvanft.io You can contact NUVA NFT by email on <a href="mailto:enquiry@metanuva.com" className="text-blue-500 hover:text-blue-600">enquiry@metanuva.com</a>
        </div>
      </div>
      <Footer />
    </div>
