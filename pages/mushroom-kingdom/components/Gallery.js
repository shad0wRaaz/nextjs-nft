	    ...
	    <div className="container mx-auto p-8">
            <div className="section-header aos-init aos-animate" data-aos="fade-up" data-aos-duration="1000">
                <div className="section-header__content flex justify-center flex-col text-center m-auto">
                    ...
                    <p className="m-auto text-3xl font-oregano">In the enchanting land of the Mushroom Kingdom, a diverse array of beings thrived, each playing a unique role in shaping the fate of their realm. Among these were the peaceful and hardworking Nomins, the malevolent Grutzis seeking power, the noble and brave Hidois, and the resolute and compassionate ruler, King Kaioji.</p>
                </div>
            </div>
