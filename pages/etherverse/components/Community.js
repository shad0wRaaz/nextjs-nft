        ...
        <div className="container mx-auto p-8">
            <div className="comminity__wrapper">
                <div className="community__content text-center aos-init aos-animate" data-aos="zoom-in" data-aos-duration="1000">
                    <h2 className="text--3d leading-normal mb-5 !text-5xl !md:text-7xl">Join The <br/> <span className="color--gradient-mv d-block">Majestic Visions</span></h2>
                    <p className="text-xl mb-8">Join a growing community of Visionaries!</p>
