            ...
            <div className="section-header aos-init aos-animate" data-aos="fade-up" data-aos-duration="1000">
                <div className="section-header__content text-center w-full max-w-[1000px] mx-auto">
                    <h2 className=" text-4xl md:text-[4.5rem] leading-normal"> 
                        <span className="mushroom-kingdom-gradient font-hennypenny"> Mushroom Kingdom <br/>Roadmap</span></h2>
                    ...
                    <div className="roadmap__item aos-init" data-aos="fade-left" data-aos-duration="1000">
                        <div className="roadmap__inner">
                            ...
                            <div className="roadmap__content">
                                ...
                                <p>5,000 NFTs in Nomin and Grutzi, 10,000 NFTs in Hidoi and 20,000 NFTs in Kaioji will be ready to mint/buy and sell.</p>
                            </div>
                        </div>
                    </div>
                    </div>
                    ...
                    <div className="roadmap__item aos-init" data-aos="fade-left" data-aos-duration="1000">
                        <div className="roadmap__inner">
                            ...
                            <div className="roadmap__content">
                                ...
                                <p>All the Holders will be Airdroped ETHs in different phases. Early birds will have potential to get 4 times more Airdrops.</p>
                            </div>
                        </div>
                    </div>
                    </div>
