...
const Faq = ({ setShowMenu }) => {
    const faqs = [
        ...
        {
            title: 'When does Free MATIC Airdrop take place?',
  ...
  return (
    <section 
        ...
        id="faq" className="faq font-oregano text-3xl py-[70px] md:py-[100px] bg-[#23162c]">
                    ...
                    <div className="text-center mx-auto">
                        <div className="section-header">
                            <div className="section-header__content text-start">
                                <h2 className="mx-0 text-center"> <span className="mushroom-kingdom-gradient font-hennypenny"> F.A.Q.</span></h2>
                            </div>
                        </div>
                                    ...
                                    {({ open }) => (
                                        <div className="mt-3">
                                            <Disclosure.Button 
                                                ...
                                                className="flex w-full justify-between rounded-lg px-4 py-5 text-left  font-medium text-[#0d142f]">
                                                <span className="font-hennypenny">{faq.title}</span>
                                                <HiChevronDown
                                                className={`${
