...
const Header = ({setShowMenu, showMenu}) => {
  ...
  return (
    <header className="header bg-[#23162c00] backdrop-blur-lg alphaslab text-neutral-100 fixed z-50 w-full font-oregano text-2xl">
            ...
            <nav className="navbar navbar-expand-xl flex !justify-between"  style={{ padding: '0 !important'}}>
                ...
                <div ref={menuRef} className={`md:flex ${!showMenu && 'hidden'} justify-end items-center flex-wrap flex-col w-full md:flex-row pb-4`} id="">
                    <div className="navbar-nav">
                        ...
                        <a className="nav-link text-center" href="/furrygrace/Whitepaper.pdf" target="_blank">Whitepaper</a>
        ...
        <Transition appear show={showAbout} as={Fragment}>
            <Dialog as="div" className="relative z-10" onClose={() => setShowAbout(false)}>
                ...
                <div className="fixed inset-0 overflow-y-auto">
                    ...
                    >
                        <Dialog.Panel className="font-oregano text-xl h-[450px] md:h-fit relative top-[1rem] max-w-4xl transform overflow-scroll md:overflow-hidden rounded-2xl bg-[#ffffffbb] backdrop-blur-lg p-[3rem] text-left align-middle shadow-xl transition-all">
                            <Dialog.Title
                                as="h3"
                            ...
                            <div className="text-slate-800 text-xl">
                                <p className="mb-4">THE TIME IS NOW<br/>Break free from the norm and take control of your future. On August 1st, 2023, the world's first-ever referral and recurring income opportunity is launching with the Mushroom Kingdom Nuva NFT collections! Take action today for paydays from the 1st of August; all payments will be in ETH.</p>
                                <p className="mb-4">This is your time, your opportunity to get in on the ground floor and take advantage of the optimum timing. It's simple; you only need to register your wallet on the Nuva NFT site and ensure you have ETH to purchase your own NFTs and enjoy the benefits.  All of this without the need for registration or KYC!</p>
                                <p className="mb-4">Simply connect with like-minded individuals and influencers since this is just the start. The ETH program is merely the beginning, as you will be able to earn with the same network with four different programs!</p>
                                <p className="">The time is now! Don't wait, don't hesitate, take advantage of this enormous opportunity to change your life. Join the revolution, register today, and get ready to reap the benefits of Referral and Recurring Income with Mushroom Kingdom Nuva NFT collections - And yes, it's a DeFi. And yes, it's ONLY on nuvanft.io. <br/> <br/>Launching on 1st of August, 2023.<br/>This is YOUR time. Are you ready?</p>
                            </div>
                        </Dialog.Panel>
                    </Transition.Child>
                    </div>
