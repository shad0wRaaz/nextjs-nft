...
import bannerbg from '../assets/images/banner-bg-mv.jpeg'
...
const Videos = ({ setShowMenu }) => {
  return (
    <section id="videos" 
      onClick={() => setShowMenu(false)} className="community alfaslab ad-basecolor py-[70px] md:py-[100px]" style={{backgroundImage: `url(${bannerbg.src})`, backgroundSize: 'cover'}}>
        <div className="container mx-auto p-8">
            <div className="comminity__wrapper">
                <div className="community__content text-center aos-init aos-animate" data-aos="zoom-in" data-aos-duration="1000">
                    <h2 className="text--3d leading-normal mb-5 !text-5xl !md:text-7xl"><span className="color--gradient-mv d-block">Tutorial Videos </span></h2>
                    ...
                    <div className="grid gap-4 grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
                        ...
                        <div>
                            ...
                            <p className="my-4">Nuva NFT Admirable Depictions Whitepaper</p>
                        </div>
                    </div>
                </div>
            </div>
