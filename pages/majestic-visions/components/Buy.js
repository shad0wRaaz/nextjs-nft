                                ...
                                <div className="mt-[3rem]">
                                    <div className="mint__item">
                                        <div className="mint__inner">
                                            ...
                                            <h4 className="mint__name text-uppercase">{(50 / Number(coins?.ethprice)).toFixed(5)} ETH</h4>
                                        </div>
                                    </div>
                                </div>
                                <div className="mt-[3rem]">
                            ...
                            <div className="grid grid-cols-2 md:grid-cols-4">
                                ...
                                <div className="mt-[3rem]">
                                    ...
                                    <div className="mint__inner">
                                        ...
                                        <h4 className="mint__name text-uppercase">{(125 / Number(coins?.ethprice)).toFixed(5)} ETH</h4>
                                    </div>
                                    </div>
                                </div>
                                <div className="mt-[3rem]">
                                ...
                                <div className="mt-[3rem]">
                                    <div className="mint__item">
                                        <div className="mint__inner">
                                            ...
                                            <h4 className="mint__name text-uppercase">{(200 / Number(coins?.ethprice)).toFixed(5)} ETH</h4>
                                        </div>
                                    </div>
                                </div>
                                <div className="mt-[3rem]">
                            ...
                            <div className="grid grid-cols-2 md:grid-cols-4">
                                ...
                                <div className="mt-[3rem]">
                                    ...
                                    <div className="mint__inner">
                                        ...
                                        <h4 className="mint__name text-uppercase">{(250 / Number(coins?.ethprice)).toFixed(5)} ETH</h4>
                                    </div>
                                    </div>
                                </div>
                                <div className="mt-[3rem]">
