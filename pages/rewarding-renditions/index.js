...
const index = () => {
  ...
  const SEO = {
    title: 'Rewarding Renditions: Nuva NFT',
  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:quote" key="og:quote" content={SEO.quote} />
        <meta property="og:hashtag" key="og:hashtag" content={SEO.hashtag} />
        <meta property="og:image" key="og:image" content={SEO.image} />
        <meta property="og:url" key="og:url" content={SEO.currentUrl} />
        <meta property="og:site_name" key="og:site_name" content={SEO.sitename} />
        ...
        <meta property="url" content={SEO.currentUrl} />
        <meta property="image" content={SEO.image} />
        <meta property="title" key="title" content={SEO.title} />
        <meta property="quote" key="quote" content={SEO.quote} />
