            ...
            <div className="container mx-auto p-8">
                <div className="footer__content text-center">
                    ...
                    <ul className="social justify-content-center flex justify-center gap-3 mt-8">
                        <li className="social__item transition hover:-translate-y-1"><Link href="https://discord.gg/DgbeEPBhUw" className="social__link"><a target="_blank" aria-label='Discord'><img src={discord.src} alt="Discord"/></a></Link></li>
