        ...
        <div className="footer__wrapper alfaslab bg-[#23162c] py-[70px] md:py-[100px] !pb-0" data-aos="fade-up" data-aos-duration="1000">
            <div className="container mx-auto p-8">
                <div className="footer__content text-center">
                    ...
                    <li className="social__item transition hover:-translate-y-1"><Link href="https://discord.gg/PvuruVjgpz" className="social__link"><a target="_blank"><img src={discord.src} alt="Discord"/></a></Link></li>
