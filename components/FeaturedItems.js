    ...
    <div className="rounded-xl">
        <a href={`/nfts/${item?._id}`}>
            <div className="coverImage h-[485px] w-full rounded-xl relative" style={{backgroundImage : `url(${item?.nft?.metadata?.image})`, backgroundSize: 'cover'}}>
                <div className="rounded-xl absolute -bottom-[80px] hover:translate-x-20 transition p-6 px-8 md:w-[400px] sm:w-[100%] m-3 z-10 shadow-2xl bg-white border border-neutral-50/30 backdrop-blur-md">
                  <button className="px-3.5 h-10 flex items-center justify-center rounded-full absolute top-3 right-4 z-10 !h-9">
