...
//   switch (action.type) {
//     case 'CHANGE_NAME':
//       tvar = { ...state.metadata, name: action.payload.name }
//       return { ...state, metadata: tvar }
//     case 'CHANGE_IMAGE':
//       tvar = { ...state.metadata, image: action.payload.image }
//       return { ...state, metadata: tvar }
//     case 'CHANGE_DESCRIPTION':
//       tvar = { ...state.metadata, description: action.payload.description }
//       return { ...state, metadata: tvar }
//     case 'CHANGE_EXTERNAL_LINK':
//       tvar = { ...state.metadata, external_link: action.payload.external_link }
//       return { ...state, metadata: tvar }
//     case 'CHANGE_BANNER_IMAGE':
//       tvar = { ...state.sanitydata, bannerImage: action.payload.bannerImage }
//       return { ...state, sanitydata: tvar }
//     case 'CHANGE_CATEGORY':
//       tvar = { ...state.sanitydata, category: action.payload.category }
//       return { ...state, sanitydata: tvar }
//     case 'CHANGE_FEE_RECIPIENT':
//       tvar = { ...state.metadata, fee_recipient: action.payload.fee_recipient }
//       return { ...state, metadata: tvar }
//     case 'CHANGE_PLATFORM_FEE_BASIS_POINTS':
//       tvar = {
//         ...state.metadata,
//         platform_fee_basis_points: action.payload.platform_fee_basis_points,
//       }
//       return { ...state, metadata: tvar }
//     case 'CHANGE_PLATFORM_FEE_RECIPIENT':
//       tvar = {
//         ...state.metadata,
//         platform_fee_recipient: action.payload.platform_fee_recipient,
//       }
//       return { ...state, metadata: tvar }
//     case 'CHANGE_PRIMARY_SALE_RECIPIENT':
//       tvar = {
//         ...state.metadata,
//         primary_sale_recipient: action.payload.primary_sale_recipient,
//       }
//       return { ...state, metadata: tvar }
//     case 'CHANGE_SELLER_FEE_BASIS_POINTS':
//       tvar = {
//         ...state.metadata,
//         seller_fee_basis_points: action.payload.seller_fee_basis_points,
//       }
//       return { ...state, metadata: tvar }
//     case 'CHANGE_SYMBOL':
//       tvar = { ...state.metadata, symbol: action.payload.symbol }
//       return { ...state, metadata: tvar }
//     case 'CHANGE_TRUSTED_FORWARDERS':
//       return { ...state, trusted_forwarders: action.payload.trusted_forwarders }
//     case 'CLEAR_OUT_ALL':
//       return {
//         metadata: {
//           name: '',
