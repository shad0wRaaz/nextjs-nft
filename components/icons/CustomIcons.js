...
export const IconVerified = () => {
  return (
    <svg class="h-5 w-5" viewBox="0 0 17 17" fill="none">
      <path
...
export const IconAvalanche = ({ width, height }) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={width ? width : '15'} height={height ? height : '15'} viewBox="0 0 40 40" fill="none" className="mr-2 inline-block">
