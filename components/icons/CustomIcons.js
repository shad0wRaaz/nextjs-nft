...
export const IconVerified = ({fontSize}) => {
  return (
    <svg className={fontSize ? `h-${fontSize} w-${fontSize}` : 'h-5 w-5' } viewBox="0 0 17 17" fill="none">
      <path
...
export const IconPolygon = ({ width, height }) => {
  return (
    <svg
...
export const IconUSDT = ({width, height}) => {
  return(
    <svg
      ...
      className="inline-block mr-1">
        <path d="M62.15,1.45l-61.89,130a2.52,2.52,0,0,0,.54,2.94L167.95,294.56a2.55,2.55,0,0,0,3.53,0L338.63,134.4a2.52,2.52,0,0,0,.54-2.94l-61.89-130A2.5,2.5,0,0,0,275,0H64.45a2.5,2.5,0,0,0-2.3,1.45h0Z"
          fillRule="evenodd"
          fill="#50af95"/>
