...
const style = {
    ...
    input: 'mt-4 outline-none p-3 border rounded-xl transition linear',
            ...
            <form name="reportForm" onSubmit={handleSubmit}>
                <div className="w-full flex flex-col">
                    ...
                    <Listbox value={selected} onChange={setSelected}>
                        ...
                        <Listbox.Button className={`relative w-full cursor-default rounded-lg border border-neutral-100 ${dark ? 'bg-slate-700 border-sky-700/30' : 'bg-white border-neutral-100'} py-4 pl-3 pr-10 text-left shadow-md focus:outline-none focus-visible:border-indigo-500 focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75 focus-visible:ring-offset-2 focus-visible:ring-offset-orange-300 sm:text-sm`}>
                    ...
                    {selected.name == "Others" && (
                        <textarea className={style.input} rows={5} value={otherDescription} onChange={(e) => setOtherDescription(e.target.value)} placeholder="Enter Description"></textarea>
                    )}
